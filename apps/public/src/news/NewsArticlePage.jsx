...
export default function NewsArticlePage({ slug }) {
    ...
    return (
      <main className="min-h-screen bg-slate-950 text-white py-24">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl font-bold mb-6">This news article is unavailable</h1>
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white pb-24">
      <article className="max-w-4xl mx-auto px-6 pt-14">
        ...
        <header className="mt-8 mb-10">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold leading-tight mb-4">{post.title}</h1>
        ...
        <img src={post.heroImage} alt={post.title} className="rounded-[28px] w-full h-[420px] object-cover mb-10" />
